...
url=ur.urlopen("http://www.mostransavto.ru/?page=rasp&code=-685476434&ak=7&n=32&com=0")
f=url.read().decode("cp1251")
#---------------------------------------
regular=r"[0-9]{2}:[0-9]{2}"
pat1=re.compile(regular)
regular2=r"Проспект Дружбы|Долгопрудная|/([0-9]{2}:[0-9]{2}/){1}|/([0-9]{2}:[0-9]{2}/){10}"
regular4="Проспект Дружбы.{1,400}</td></tr>|Долгопрудная.{1,400}</td></tr>"
