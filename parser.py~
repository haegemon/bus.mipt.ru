...
url=ur.urlopen("http://mostransavto.ru/?page=rasp&code=-1546379448&ak=7&n=368")
f=url.read().decode("cp1251")
#---------------------------------------
regular=r"[0-9]{2}:[0-9]{2}"
pat1=re.compile(regular)
regular2="Речной вокзал|Долгопрудная|[0-9]{2}:[0-9]{2}"
...
for l in temp:
	...
	l=pat2.findall(l)
	if len(l)==11:
		d=dict({"place":l[0], "пвсчп":[l[1],l[6]], "св":[l[2],l[3],l[5]], "пвсчпсв":[l[4],l[7],l[8],l[9],l[10]]})
		r[o]=dict(d)
	elif len(l)==9:
...
s='insert into main(reis_name, reis_number, start_date, end_date, type) values('
